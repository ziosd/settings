...
exports.defaultBuildValue = defaultBuildValue;
...
function build(variables) {
  ...
  var regex = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : /^GPLATFORM_SETTINGS_/;
  var buildValue = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : defaultBuildValue;

  var filteredVariables = processSettings(variables, regex, buildValue);
 ...
 */
function toObject(defaults, json) {
  return json ? JSON.parse(defaults) : require(defaults);
}

var json = /^(\[|\{).*(\]|\})$/;

function defaultBuildValue(value) {
  return json.test((value || '').trim()) ? JSON.parse(value) : value;
}

function processSettings(variables) {
  var regex = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : /^GPLATFORM_SETTINGS_/;
  var buildValue = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : defaultBuildValue;
 ...
 */
function buildSettings(variables) {
  var separator = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '_';
